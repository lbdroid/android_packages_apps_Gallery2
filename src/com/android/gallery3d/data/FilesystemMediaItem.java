...
//
public abstract class FilesystemMediaItem extends MediaItem {

    @SuppressWarnings("unused")
    private static final String TAG = "FilesystemMediaItem";
    ...
    public FilesystemMediaItem(Path path, long version) {
        super(path, version);
    }
