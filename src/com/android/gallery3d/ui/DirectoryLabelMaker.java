...
public class DirectoryLabelMaker {
    private static final int BORDER_SIZE = 0;

    private final AlbumSlotRenderer.LabelSpec mSpec;
    ...
    public DirectoryLabelMaker(Context context, AlbumSlotRenderer.LabelSpec spec) {
        mContext = context;
        mSpec = spec;
    ...
    private class AlbumLabelJob implements ThreadPool.Job<Bitmap> {
        ...
        public Bitmap run(JobContext jc) {
            AlbumSlotRenderer.LabelSpec s = mSpec;
